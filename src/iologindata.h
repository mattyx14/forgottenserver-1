...
class IOLoginData
{
	public:
		...
		bool loginserverAuthentication(uint32_t name, const std::string& password, Account& account);
		uint32_t gameworldAuthentication(uint32_t accountName, const std::string& password, std::string& characterName);
